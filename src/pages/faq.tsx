      ...
      <Box direction="column" align="center" width="medium">
        ...
        <Accordion width="medium">
          ...
          <AccordionPanel label={<SiteHeading level="5">Disclaimer</SiteHeading>}>
            <Text margin={textMargin}>
              We are not affiliated with Larva Labs, we just love and respect the ideas and philosophy behind the movement they created, with intention to further cement and
              clarify their validity and pioneering ideas in a creative and community driven, decentralised way. ADAPunkz parodies and explores art subculture in a respectful and
              honorific manner.
            </Text>
          </AccordionPanel>
        </Accordion>
